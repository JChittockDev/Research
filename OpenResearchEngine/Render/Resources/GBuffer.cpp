...
void GBuffer::BuildDescriptors(CD3DX12_CPU_DESCRIPTOR_HANDLE& cpuRtvHandle, CD3DX12_CPU_DESCRIPTOR_HANDLE& cpuSrvHandle, CD3DX12_GPU_DESCRIPTOR_HANDLE& gpuSrvHandle, UINT rtvDescriptorSize, UINT srvDescriptorSize)
{
    ...
    mhViewNormalCpuRtv = cpuRtvHandle.Offset(1, rtvDescriptorSize);
    ...
    mhViewNormalCpuSrv = cpuSrvHandle.Offset(1, srvDescriptorSize);
    ...
    mhViewNormalGpuSrv = gpuSrvHandle.Offset(1, srvDescriptorSize);
...
void GBuffer::RebuildDescriptors()
{
    ...
    CreateGBufferRTV(DXGI_FORMAT_R16G16B16A16_FLOAT, mViewNormal, mhViewNormalCpuRtv);
    ...
    CreateGBufferSRV(DXGI_FORMAT_R16G16B16A16_FLOAT, mViewNormal, mhViewNormalCpuSrv);
...
void GBuffer::BuildResources()
{
    ...
    CreateGBufferTexture(DXGI_FORMAT_R16G16B16A16_FLOAT, mViewNormal);
