...
void EngineApp::UpdateSssCB(const GameTimer& gt)
{
    ...
    static float anisotropy = 0.5f;
    static float thickness = 0.5f;
    static float scale = 1.0f;
    static DirectX::XMFLOAT3 transmissionColor(0.5, 0.5, 0.5);
    static DirectX::XMFLOAT3 scatteringProfile(0.5, 0.5, 0.5);
    static int sampleCount = 16;
    ...
    if (ImGui::TreeNode("SSS Settings"))
    {
        ...
        ImGui::SliderFloat("Anisotropy", &anisotropy, 0.001f, 10.0f, "%.3f");
