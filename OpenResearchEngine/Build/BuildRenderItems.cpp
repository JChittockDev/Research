...
void EngineApp::BuildRenderItems()
{
	RenderItem::BuildRenderItem("shapeGeo", "sphere", "sky", DirectX::XMFLOAT3(0.0f, 0.0f, 0.0f), DirectX::XMFLOAT4(0.0, 0.0, 0.0, 1.0), 
		DirectX::XMFLOAT3(5000.0f, 5000.0f, 5000.0f), ObjectCBIndex, mGeometries, mMaterials, mTransforms, mRitemLayer[(int)RenderLayer::Sky], mAllRitems);

	RenderItem::BuildRenderItem("shapeGeo", "quad", "bricks0", DirectX::XMFLOAT3(0.0f, 0.0f, 0.0f), DirectX::XMFLOAT4(0.0, 0.0, 0.0, 1.0),
		DirectX::XMFLOAT3(1.0f, 1.0f, 1.0f), ObjectCBIndex, mGeometries, mMaterials, mTransforms, mRitemLayer[(int)RenderLayer::Debug], mAllRitems);

	RenderItem::BuildRenderItem("shapeGeo", "box", "bricks0", DirectX::XMFLOAT3(0.0f, 0.5f, 0.0f), DirectX::XMFLOAT4(0.0, 0.0, 0.0, 1.0),
		DirectX::XMFLOAT3(2.0f, 1.0f, 2.0f), ObjectCBIndex, mGeometries, mMaterials, mTransforms, mRitemLayer[(int)RenderLayer::Opaque], mAllRitems);

	RenderItem::BuildRenderItem("shapeGeo", "grid", "tile0", DirectX::XMFLOAT3(0.0f, 0.0f, 0.0f), DirectX::XMFLOAT4(0.0, 0.0, 0.0, 1.0),
		DirectX::XMFLOAT3(1.0f, 1.0f, 1.0f), ObjectCBIndex, mGeometries, mMaterials, mTransforms, mRitemLayer[(int)RenderLayer::Opaque], mAllRitems);
