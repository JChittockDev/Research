...
{
    LoadStaticMesh(device, commandList, diffuseSrvHeapIndex, normalSrvHeapIndex, matCBIndex, textureDefinitions, filePath);
}
    ...
    const std::string& filePath)
{
    ...
    M3DLoader m3dLoader;
    m3dLoader.LoadM3d(filePath, vertices, indices, subsets, mats);
