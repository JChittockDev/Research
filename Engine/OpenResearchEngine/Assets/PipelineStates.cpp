...
void AssetManager::SetPipelineStates()
{
    ...
    ThrowIfFailed(mDevice->CreateComputePipelineState(&blendComputePSO, IID_PPV_ARGS(&mPSOs["blend"])));
    ...
    ThrowIfFailed(mDevice->CreateComputePipelineState(&skinnedComputePSO, IID_PPV_ARGS(&mPSOs["skinned"])));
    ...
    ThrowIfFailed(mDevice->CreateComputePipelineState(&triangleNormalComputePSO, IID_PPV_ARGS(&mPSOs["triangleNormal"])));
    ...
    ThrowIfFailed(mDevice->CreateComputePipelineState(&vertexNormalComputePSO, IID_PPV_ARGS(&mPSOs["vertexNormal"])));
    ...
    ThrowIfFailed(mDevice->CreateComputePipelineState(&meshTransferComputePSO, IID_PPV_ARGS(&mPSOs["meshTransfer"])));
    ...
    ThrowIfFailed(mDevice->CreateComputePipelineState(&simMeshTransferComputePSO, IID_PPV_ARGS(&mPSOs["simMeshTransfer"])));
    ...
    ThrowIfFailed(mDevice->CreateComputePipelineState(&forceComputePSO, IID_PPV_ARGS(&mPSOs["force"])));
    ...
    ThrowIfFailed(mDevice->CreateComputePipelineState(&tensionComputePSO, IID_PPV_ARGS(&mPSOs["tension"])));
    ...
    ThrowIfFailed(mDevice->CreateComputePipelineState(&preSolveComputePSO, IID_PPV_ARGS(&mPSOs["preSolve"])));
    ...
    ThrowIfFailed(mDevice->CreateComputePipelineState(&postSolveComputePSO, IID_PPV_ARGS(&mPSOs["postSolve"])));
    ...
    ThrowIfFailed(mDevice->CreateComputePipelineState(&constraintSolveComputePSO, IID_PPV_ARGS(&mPSOs["constraintSolve"])));
    ...
    colorEdgeBlurPsoDesc.DepthStencilState.DepthEnable = false;
    colorEdgeBlurPsoDesc.DepthStencilState.DepthWriteMask = D3D12_DEPTH_WRITE_MASK_ZERO;
    mDevice->CreateGraphicsPipelineState(&colorEdgeBlurPsoDesc, IID_PPV_ARGS(&mPSOs["Composite"]));
