...
void AssetManager::CompileShaders(const DynamicLights& lights)
{
    std::string numDirectionalLights = std::to_string(lights.DirectionalLights.size());
    std::string numPointLights = std::to_string(lights.PointLights.size());
    std::string numSpotLights = std::to_string(lights.SpotLights.size());
