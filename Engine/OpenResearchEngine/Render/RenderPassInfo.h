#pragma once
#include "IRenderPassInfo.h"

class RenderPassInfo : public IRenderPassInfo
{
public:
	RenderPassInfo(ID3D12Device* device);
	RenderPassInfo(const RenderPassInfo& rhs) = delete;
	RenderPassInfo& operator=(const RenderPassInfo& rhs) = delete;
