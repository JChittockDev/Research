...
#pragma region CustomeEditorTab

/// <summary>
/// Function to Register a nomad tab window
/// </summary>
void FSuperManagerModule::RegisterAdvancedDeletionTab()
{
	// Spawn a nomad tab window
...
{
	TArray<TSharedPtr<FAssetData>> AvalibleAssetsData;

	TArray<FString> AssetsPathsInDirectory = UEditorAssetLibrary::ListAssets(FolderPathsSelected[0]);

	for (const FString& AssetPathName : AssetsPathsInDirectory)
	{
		...
		AvalibleAssetsData.Add(MakeShared<FAssetData>(Data));
	}
	
	return AvalibleAssetsData;
}

/// <summary>
/// Function to actually create a nomad tab window
/// </summary>
/// <param name="TabArgs"></param>
/// <returns></returns>
TSharedRef<SDockTab> FSuperManagerModule::OnSpawnAdvancedDeletionTab(const FSpawnTabArgs& TabArgs)
{
	return SNew(SDockTab).TabRole(ETabRole::NomadTab)
	[
		// defines the arguments for the tab
...
/// This function initiliazes the menu extension
void FSuperManagerModule::InitCBMenuExtention()
{	
	// load in the the content browser
